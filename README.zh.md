...
| 平台 | 状态 |
| :--- | :--- |
| **ChatGPT** | ✅ v4.5.0 之后唯一支持的平台 |
| **Gemini** | ⚠️ 从 v4.5.0 开始下线适配 |
| **Claude** | ⚠️ 从 v4.5.0 开始下线适配 |
| **DeepSeek** | ⚠️ 从 v4.5.0 开始下线适配 |

AI-MarkDone 接下来会回到 ChatGPT-only 的方向。从 v4.5.0 开始，Gemini、Claude 和 DeepSeek 的适配将下线，ChatGPT 将作为本插件唯一支持的平台。
...
### 4.4.6
- 将 Chrome 提交包标题更新为“AI-MarkDone — ChatGPT 导航、阅读与知识整理插件”。
