...
### Added
- Settings: Added an Advanced Settings section with a Reader content width control, plus previous/next message buttons at the bottom of the ChatGPT right-side directory.
