...
Friends, the fix is here. ChatGPT made a major update to its website last week, which changed the page elements and where its content is stored. I then released 5.2.0, but that version involved fairly large changes and had not been tested enough, so it introduced some new bugs. This release fixes some of the known new issues and I hope it gives everyone a better experience. If you run into any problems, please email us or join the group to share feedback. Your participation will greatly help improve this extension. I will also stay true to the original goal and continue building this project as a focused productivity extension.
