...
export const Icons = {
    ...
    /**
     * Chevron up icon
     * Usage: Collapse / upward disclosure
     */
    chevronUp: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    filter: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
`,
    ...
    // ============================================
    // REWRITE-ONLY ICONS (not present in legacy set)
    // ============================================

    /**
     * Refresh CW icon
     * Usage: Refresh/reload actions
     * Source: Lucide Icons (ISC License)
     */
    refreshCw: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    /**
     * Wrench icon
     * Usage: Repair/maintenance actions
     * Source: Lucide Icons (ISC License)
     */
    wrench: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.8-3.8a6 6 0 0 1-7.3 7.3l-6.9 6.9a2 2 0 0 1-2.8-2.8l6.9-6.9a6 6 0 0 1 7.3-7.3z"/>
  </svg>`,

    /**
     * Sigma icon
     * Usage: Word count/statistics
     * Source: Lucide Icons (ISC License)
     */
    sigma: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M18 4H7l6 8-6 8h11"/>
  </svg>`,

    /**
     * Move icon
     * Usage: Move/reorder actions
     * Source: Lucide Icons (ISC License)
     */
    move: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M12 2v20"/>
    ...
    /**
     * Sort icons (A-Z / 0-1)
     * Usage: Bookmarks panel sorting toggles
     * Source: Lucide Icons (ISC License)
     */
    arrowDownAZ: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 16h5"/>
    <path d="M3 12h8"/>
    <path d="M3 8h11"/>
    <path d="M13 16h6"/>
    ...
    arrowUpAZ: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 16h5"/>
    <path d="M3 12h8"/>
    <path d="M3 8h11"/>
    <path d="M13 16h6"/>
    ...
    arrowDown10: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 16h7"/>
    <path d="M3 12h4"/>
    <path d="M3 8h4"/>
    <path d="M13 16h6"/>
    ...
    arrowUp01: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 16h7"/>
    <path d="M3 12h4"/>
    <path d="M3 8h4"/>
    <path d="M13 16h6"/>
...
// -------------------------------------------------------------------------------------
// Named exports (compat layer)
// - Keep current rewrite modules importing individual constants.
// - All icons originate from the legacy `Icons` set above (or the minimal rewrite-only add-ons).
// -------------------------------------------------------------------------------------
...
export const pencilIcon = Icons.edit;
...
export const arrowDown10Icon = Icons.arrowDown10;
export const arrowUp01Icon = Icons.arrowUp01;
export const sortAZIcon = Icons.sortAZ;
export const sortTimeIcon = Icons.sortTime;
export const sortTimeAscIcon = Icons.sortTimeAsc;
export const sortAlphaAscIcon = Icons.sortAlphaAsc;
