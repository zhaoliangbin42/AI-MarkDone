...
:host {
  ...
  --aimd-ref-color-black-alpha-16: rgba(0,0,0,0.16);
  --aimd-ref-color-black-alpha-24: rgba(0,0,0,0.24);
  --aimd-ref-color-white-alpha-10: rgba(255,255,255,0.10);
  --aimd-ref-color-white-alpha-16: rgba(255,255,255,0.16);
  --aimd-ref-color-white-alpha-18: rgba(255,255,255,0.18);
  --aimd-ref-color-white-alpha-28: rgba(255,255,255,0.28);
  ...
  --aimd-ref-color-overlay-heavy: ${isDark ? 'rgba(0,0,0,0.60)' : 'rgba(148, 163, 184, 0.34)'};
  --aimd-ref-color-warning: ${isDark ? '#fbbf24' : '#f59e0b'};
  --aimd-ref-color-warning-text: ${isDark ? '#fbbf24' : '#b45309'};
  ...
  --aimd-ref-shadow-md: ${isDark ? '0 10px 24px rgba(0,0,0,0.56)' : '0 8px 20px rgba(0,0,0,0.14)'};
