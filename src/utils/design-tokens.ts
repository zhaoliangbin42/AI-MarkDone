    ...
    static getAimdSemanticTokens(isDark: boolean): string {
        if (isDark) {
            return `
                ...
                --aimd-toolbar-shadow-1: rgba(96, 165, 250, 0.2);
                --aimd-toolbar-shadow-2: rgba(96, 165, 250, 0.1);
                --aimd-toolbar-hover-shadow-1: rgba(96, 165, 250, 0.3);
                --aimd-toolbar-hover-shadow-2: rgba(96, 165, 250, 0.2);
            ...
            return `
                ...
                --aimd-toolbar-shadow-1: rgba(59, 130, 246, 0.15);
                --aimd-toolbar-shadow-2: rgba(59, 130, 246, 0.1);
                --aimd-toolbar-hover-shadow-1: rgba(59, 130, 246, 0.25);
                --aimd-toolbar-hover-shadow-2: rgba(59, 130, 246, 0.15);
