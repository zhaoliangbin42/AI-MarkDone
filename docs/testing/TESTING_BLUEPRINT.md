...
- Materialization and consumer-boundary tests prove DOM remounts do not change semantic tokens, ChatGPT toolbar owns no second observer/route watcher, pending anchors do not inject into React-owned action rows, and consumers do not add their own DOM fallback discovery.
