...
- 长期样式系统规则、Tailwind 使用边界、Shadow DOM 样式注入、mock-first UI 流程变化（更新 `docs/design.md` 与相关测试文档）
...
- `docs/design.md`：长期 UI 样式规则、Tailwind 边界、Shadow DOM 样式注入、mock-first 视觉流程
